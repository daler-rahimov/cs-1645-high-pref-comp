...
#define ID_SERVER_DATA_GENERATED 		MAX_RAND_NUMS+2 		// flag indicating data has been generated by the server process
#define ID_CLIENT_SECOND_HALF_SORTED	MAX_RAND_NUMS+3			// flag indicating SECOND half of the data has been sorted
#define ID_SERVER_FIRST_HALF_SORTED 	MAX_RAND_NUMS+4			// flag indicating FIRST half of the data has been sorted
#define ID_CLIENT_1_CONNECTED			MAX_RAND_NUMS+5 		// client has connected
